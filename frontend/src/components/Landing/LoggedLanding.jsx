            ...
            <nav className="bg-[#353f94] px-4 md:px-6 py-4 border-b-5 border-yellow-400 sticky top-0 z-50">
                                    ...
                                    <div className="absolute right-0 mt-3 w-64 bg-[#4a5899] rounded-lg shadow-xl overflow-hidden border-2 border-[#353f94]">
                                        ...
                                        <div className="px-4 py-3 bg-[#3d4785] border-b border-[#353f94]">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-white font-semibold text-lg">Juan Corporation</p>
                                                    <p className="text-gray-300 text-sm">JuanCorp@gmail</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className={`md:hidden bg-[#353f94] transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0 overflow-hidden' 
                    ...
                    <div className="mt-5 border-t-2 border-white">
                        ...
                        <button className="w-full text-left px-1 py-2 text-2xl text-white hover:text-yellow-400 transition-colors duration-200">
                            Sign Out
                        </button>
                    </div>
                </div>
