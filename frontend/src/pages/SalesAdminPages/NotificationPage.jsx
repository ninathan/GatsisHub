...
const NotificationPage = () => {
    ...
    const { isSubscribed } = useRealtimeAdminNotifications('sales_admin', handleNewNotification);
    ...
    const markAllAsRead = async () => {
        try {
            const response = await fetch('https://gatsis-hub.vercel.app/admin-notifications/read-all/sales_admin', {
                method: 'PATCH',
            });
