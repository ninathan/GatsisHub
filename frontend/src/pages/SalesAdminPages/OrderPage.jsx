                ...
                <div className="flex flex-wrap items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center border rounded px-3 py-2 bg-white">
                            ...
                            <input
                                type="text"
                                placeholder="Search by order ID, company, or contact person"
                                ...
                                filteredOrders.map((order) => {
                                    ...
                                    return (
                                        <tr key={order.orderid} className="border-t hover:bg-gray-50">
                                            ...
                                            <td className="px-4 py-3">{formatDate(order.datecreated)}</td>
                                            <td className="px-4 py-3">
                                                <div>
                                            ...
                                            <td className="px-4 py-3">{order.quantity}x</td>
                                            <td className="px-4 py-3">
                                                <Link 
                                                    to={`/orderdetail/${order.orderid}`}
                                                    className="bg-yellow-400 px-4 py-1 rounded hover:bg-yellow-500 font-medium inline-block"
                                                >
                                                    View
                                                </Link>
                                            </td>
