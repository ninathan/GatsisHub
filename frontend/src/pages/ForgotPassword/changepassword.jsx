    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 min-h-screen w-full'>
            ...
            <div className='flex flex-col items-center justify-center py-10 md:py-20 px-4 order-1 lg:order-2'>
                <h1 className='text-[#191716] text-4xl md:text-6xl font-bold text-center'>
                    Change Password
                </h1>
                ...
                <button className='mt-6 bg-[#E6AF2E] text-black px-6 py-3 text-xl rounded-2xl hover:bg-[#c4ad1f]'>
