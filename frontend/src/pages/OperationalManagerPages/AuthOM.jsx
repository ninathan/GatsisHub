...
import { Lock, User, Mail, Eye, EyeOff, Settings, Package, TrendingUp } from 'lucide-react'
                    ...
                    <div className='flex flex-col items-center justify-center h-full py-8 md:py-12 lg:py-20 px-4 relative z-10'>
                        ...
                        <div className="mt-8 md:mt-10 text-center max-w-md">
                            <div className="flex items-center justify-center gap-2 mb-4">
                                <Settings className="w-8 h-8 md:w-10 md:h-10 text-[#E6AF2E]" />
                                <h1 className='text-white text-2xl md:text-3xl lg:text-4xl font-bold'>
                                    <span className="text-[#E6AF2E]">Operations</span> Portal
                                </h1>
                            </div>
                            <p className='text-gray-300 text-sm md:text-base lg:text-lg leading-relaxed mb-6'>
                                Manage production workflows, inventory, and operational efficiency.
                            </p>
                            ...
                            <div className="space-y-3 text-left">
                                <div className="flex items-center gap-3 text-gray-300">
                                    <div className="w-10 h-10 bg-[#E6AF2E]/20 rounded-lg flex items-center justify-center">
                                        <Package className="w-5 h-5 text-[#E6AF2E]" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-semibold text-white">Production Management</p>
                                        <p className="text-xs text-gray-400">Monitor & optimize workflows</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 text-gray-300">
                                    <div className="w-10 h-10 bg-[#E6AF2E]/20 rounded-lg flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400">Track KPIs & metrics</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 text-gray-300">
                                    <div className="w-10 h-10 bg-[#E6AF2E]/20 rounded-lg flex items-center justify-center">
                                        <Settings className="w-5 h-5 text-[#E6AF2E]" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-semibold text-white">Resource Planning</p>
                                        <p className="text-xs text-gray-400">Optimize operations</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="text-center mb-8 md:mb-10">
                            <div className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-full mb-4 shadow-lg">
                                ...
                                <span className="text-sm font-semibold">Operations Manager</span>
                            </div>
                        ...
                        <form onSubmit={handleLogin} className='w-full bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-200'>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type='email'
                                        placeholder='manager@gatsishub.com'
                                        value={email}
                                        onChange={(e) => setEmail(e.target.value)}
                                        className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-gray-900"
                                        required
                                        disabled={loading}
                                    />
                                </div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-gray-900"
                                        required
                                        disabled={loading}
                                    />
                                    <button
                            ...
                            <button
                                type='submit'
                                disabled={loading}
                                className="w-full bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed text-base md:text-lg flex items-center justify-center gap-2 cursor-pointer"
                            >
                                {loading ? (
                                    <>
                        ...
                        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-blue-900 mb-1">Operations Manager Access</p>
                                    <p className="text-xs text-blue-700">
                                        This portal provides access to production management, inventory control, and operational analytics.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-scaleIn">
                        ...
                        <div className="p-6 md:p-8">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#E6AF2E] to-[#d4a02a] rounded-full flex items-center justify-center mb-4">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-800">
                                                Only authorized System Administrators can reset manager passwords to maintain operational security.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end">
                            <button
                                ...
                                className="bg-gradient-to-r from-[#E6AF2E] to-[#d4a02a] text-white font-semibold px-6 py-2.5 rounded-lg transition-all shadow-md hover:shadow-lg cursor-pointer"
                            >
                                Got it, Close
                            </button>
                        </div>
