...
import { ChevronLeft, ChevronRight, Search, Package, Calendar, User, DollarSign, Eye, CheckCircle, Clock, X } from "lucide-react";
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                ...
                // Filter to only show orders with payment verification or beyond
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm md:text-base text-gray-600 mt-1">
                                Operational Manager - Monitor production orders
                            </p>
                        </div>
