    ...
    return (
        <div className='p-5'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center'>
                ...
                <div
                    ref={chequeAnim.ref}
                    className={`h-75 w-75 bg-[#191716] m-10 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-all duration-300 hover:shadow-2xl ${chequeAnim.isVisible ? 'scroll-slide-up' : 'scroll-hidden'
                        }`}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-20'>
                ...
                <div
                    ...
                    className={`h-60 w-75 border border-gray-300 rounded-lg hover:shadow-lg transition-shadow duration-300 ${chequeInfoAnim.isVisible ? 'scroll-fade-in' : 'scroll-hidden'
                        }`}
                >
